  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-2xl px-4 pb-8 pt-8">
        ...
        <p className="mt-4 text-[10px] font-medium uppercase tracking-wider text-muted-foreground">{eyebrow}</p>
        <h1 className="mt-1 font-display text-[26px] font-semibold leading-tight tracking-tight">{title}</h1>
        ...
        <p className="mt-6 text-[12px] leading-relaxed text-muted-foreground">
          OpportunityOS is being built in the open. This section is intentionally empty until the underlying data model is ready — no fake dashboards, no filler.
        </p>
      </div>
    </AppShell>
  );
